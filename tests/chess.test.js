...
test("chess constructor", () => {
  ...
  expect(JSON.stringify(fenChess.board.enPassantable)).toBe(
    JSON.stringify(chess.board.enPassantable),
  );
  ...
  let lateGame = new Chess(
    "r1bq1bnr/1p1p1k1p/p3p1p1/5p2/2BQP3/1PN5/P1P2PPP/R1B1R1K1 b - - 2 10",
  );

  expect(lateGame.toFEN()).toBe(
    "r1bq1bnr/1p1p1k1p/p3p1p1/5p2/2BQP3/1PN5/P1P2PPP/R1B1R1K1 b - - 2 10",
  );
  ...
  let badFen2 =
    "rnbqkbnr/pp1ppppp/8/2p5/9P3/8/PPPP1PPP/RNBQKKBNR w KQkq c6 0 2";
...
test("generateMoveStrs", () => {
  ...
  expect(JSON.stringify(chess.generateMoveStrs(pawnDBlack, 3, 3))).toBe(
    '["d5"]',
  );
  let knightQWhite = chess.board.get(1, 7);
  expect(JSON.stringify(chess.generateMoveStrs(knightQWhite, 2, 5))).toBe(
    '["Nc3"]',
  );
  ...
  ["d4", "Nc6", "d5", "e5"].forEach((move) => {
    chess.board.move(
      chess.board.buildMove(move, i % 2 ? Color.WHITE : Color.BLACK),
    );
    i++;
  });
  let pawnDWhite = chess.board.get(3, 3);
  expect(JSON.stringify(chess.generateMoveStrs(pawnDWhite, 4, 2))).toBe(
    '["dxe6"]',
  );
  ...
  chess.board.teamMap[Color.BLACK] = [chess.board.set(7, 0, blackKing)];

  expect(JSON.stringify(chess.generateMoveStrs(whitePawn, 1, 0))).toBe(
    '["b8=Q","b8=N"]',
  );

  let blackKnight = new Knight(Color.BLACK, 0, 0);
  chess.board.teamMap[Color.BLACK].push(chess.board.set(blackKnight, 0, 0));
  expect(JSON.stringify(chess.generateMoveStrs(whitePawn, 0, 0))).toBe(
    '["bxa8=Q","bxa8=N"]',
  );
  ...
  expect(JSON.stringify(chess.generateMoveStrs(queen2, 3, 3))).toBe(
    '["Qb3d5"]',
  );
});
...
test("legal moves", () => {
  ...
  chess = new Chess(
    "n2R4/P1Pn4/1rB1NpKP/1pqQ1r1P/pB2PPp1/ppp3R1/1P1bPN1p/1bk5 w - - 0 1",
  );
  moveSet = chess.legalMoves();

  expect(JSON.stringify(moveSet.sort())).toBe(
    JSON.stringify(exampleSet2.sort()),
  );
  ...
  chess = new Chess(
    "rnbqk2r/pp1p1ppp/3bpn2/2p5/2B1P3/P4N2/1PPP1PPP/RNBQK2R w KQkq - 0 1",
  );
  moveSet = chess.legalMoves();
  ...
  chess = new Chess(
    "rnbqk2r/pp1p1ppp/3bpn2/2p5/2B1P3/P4N2/1PPP1PPP/RNBQK2R b KQkq - 0 1",
  );
  moveSet = chess.legalMoves();
  ...
  chess = new Chess(
    "r3kbnr/pbpp1ppp/1pn1pq2/8/6Q1/1PN1P3/PBPP1PPP/R3KBNR w KQkq - 0 1",
  );
  moveSet = chess.legalMoves();
  ...
  chess = new Chess(
    "r3kbnr/pbpp1ppp/1pn1pq2/8/6Q1/1PN1P3/PBPP1PPP/R3KBNR b KQkq - 0 1",
  );
  moveSet = chess.legalMoves();
  ...
  // both sides
  chess = new Chess(
    "r3k2r/pbppbppp/1pn1pq1n/8/6Q1/1PN1PN2/PBPPBPPP/R3K2R w KQkq - 0 1",
  );
  moveSet = chess.legalMoves();
  ...
  // blacks turn
  chess = new Chess(
    "r3k2r/pbppbppp/1pn1pq1n/8/6Q1/1PN1PN2/PBPPBPPP/R3K2R b KQkq - 0 1",
  );
  moveSet = chess.legalMoves();
  ...
  chess = new Chess(
    "rnbqk2r/ppp2ppp/7n/3pp3/4P3/b1PQ4/PP1P1PPP/RNB1KBNR w KQkq d6 0 5",
  );
  chess.move("Qb5");
