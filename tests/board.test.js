...
test("castling", () => {
    ...
    board.blackKing = blackKing;
    board.teamMap[Color.BLACK] = [board.set(0, 0, blackRook), board.set(4, 0, blackKing)];

    // add white king + rooks
    board.whiteKing = whiteKing;
    board.teamMap[Color.WHITE] = [board.set(7, 7, whiteRook), board.set(4, 7, whiteKing)];
...
test("standard promotion", () => {
    ...
    board.teamMap[Color.WHITE] = [board.set(0, 7, whiteKing), board.set(3, 1, whitePawn)];
...
test("capture promotion", () => {
    ...
    board.teamMap[Color.WHITE] = [board.set(0, 7, whiteKing), board.set(3, 1, whitePawn)];
    board.teamMap[Color.BLACK] = [board.set(7, 7, blackKing), board.set(4, 0, blackPawn)];
...
test("check promotion", () => {
    ...
    board.teamMap[Color.WHITE] = [board.set(0, 7, whiteKing), board.set(1, 1, whitePawn)];
    board.teamMap[Color.BLACK] = [board.set(1, 1, blackKing), board.set(0, 0, blackQ)];
