...
test("basic capturing", () => {
  ...
  expect(board.teamMap[Color.BLACK].find((piece) => piece === blackPawnE)).toBe(
    undefined,
  );
  ...
  expect(board.teamMap[Color.BLACK].find((piece) => piece === blackQueen)).toBe(
    undefined,
  );
...
test("en passant", () => {
  ...
  expect(board.teamMap[Color.BLACK].find((piece) => piece === pawnBlackE)).toBe(
    undefined,
  );
...
test("standard promotion", () => {
  ...
  board.teamMap[Color.BLACK] = [board.set(7, 7, blackKing)];
  ...
  expect(board.teamMap[Color.WHITE].find((piece) => piece === whitePawn)).toBe(
    undefined,
  );
  expect(board.teamMap[Color.WHITE].find((piece) => piece === whiteRook)).toBe(
    whiteRook,
  );
...
test("capture promotion", () => {
  ...
  expect(board.teamMap[Color.BLACK].find((piece) => piece === blackPawn)).toBe(
    undefined,
  );
  expect(board.teamMap[Color.WHITE].find((piece) => piece === whiteQueen)).toBe(
    whiteQueen,
  );
...
test("check promotion", () => {
  ...
  board.teamMap[Color.BLACK] = [board.set(1, 1, blackKing)];
  ...
  expect(
    board.teamMap[Color.WHITE].find((piece) => piece === whiteKnight),
  ).toBe(whiteKnight);
  expect(board.checkForCheck(Color.BLACK)).toBe(true);
