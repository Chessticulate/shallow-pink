...
module.exports = class Board {
    ...
    buildMove(moveStr, color) {
        ...
        const destX = fileMap[moveStr[moveStr.length-2]];
        ...
        if (pieceType === Pawn) {
            ...
            if (moveStr.length == 4) {
                if (!((capture = (char1 === 'x')) || (origX = fileMap[char1]) !== undefined || (origY = rankMap[char1]) !== undefined)) {
                    return null;
                }
            } else if (moveStr.length == 5) {
                if (!((origX = fileMap[char1]) !== undefined || (origY = rankMap[char1]) !== undefined)) {
                    return null;
                }
                ...
                if (!((capture = (char3 === 'x')) || (origX = fileMap[char1]) !== undefined || (origY = rankMap[char2]) !== undefined)) {
                    return null;
                }
