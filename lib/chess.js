...
module.exports = class Chess {
    ...
    move(moveStr) {
        ...
        // save moved pieces original x and y for hash update
        let piece = moves[moves.length-1].piece;
        let origX = piece.x, origY = piece.y;
        ...
        // pass in moves obj to update key
        // this.updateKey(moves, origX, origY);
