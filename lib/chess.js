...
module.exports = class Chess {
    ...
    toFEN() {
        // Who's turn, caslteable sides, enpassant space, 50 move counter and fullmove number
        let  = `${this.turn % 2 ? 'w' : 'b'}`;
        let wc = '';    
        let bc = '';
        ...
        // if enpassantable isnt null, get the color of the enpassantable piece, 
        // ep should equal the space behind the piece that is enpassantable, 
        // so add or subtract from the rank depending on the color of the piece.
    }
