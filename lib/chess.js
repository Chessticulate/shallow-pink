...
module.exports = class Chess {
    ...
    constructor(fenStr, states) {
        ...
        // console.log(this.generateZobristKey());
        // console.log(this.generateZobristKey());
    }
    ...
    // generate zobrist key from a given board position
    generateZobristKey() {
        return this.board.generateKey();
    }

    // instead of rehashing the entire board simply compute the new piece@square hash and XOR with previous position hash
    getKey() {
