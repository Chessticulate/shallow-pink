...
module.exports = class Chess {
  ...
  toFEN() {
    ...
    if (this.board.whiteKing.firstMove) {
      ...
      if (
        this.board.get(7, 7) instanceof Rook &&
        this.board.get(7, 7).firstMove
      ) {
        wc = "K";
      }
      if (
        this.board.get(0, 7) instanceof Rook &&
        this.board.get(0, 7).firstMove
      ) {
        wc = `${wc}Q`;
      }
    }
    if (this.board.blackKing.firstMove) {
      if (
        this.board.get(7, 0) instanceof Rook &&
        this.board.get(7, 0).firstMove
      ) {
        bc = "k";
      }
      if (
        this.board.get(0, 0) instanceof Rook &&
        this.board.get(0, 0).firstMove
      ) {
        bc = `${bc}q`;
      }
    }
    ...
    let enPassantPiece =
      this.board.enPassantList[this.board.enPassantList.length - 1];
    if (enPassantPiece) {
