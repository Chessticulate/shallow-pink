...
module.exports = class Chess {
    ...
    constructor(fenStr, states, book, table) {
        ...
        (parseInt(fullMoveCounter) - 1) * 2 + (turnColor === 'w' ? 1 : 2);
            this.stm = turnColor === 'w' ? Color.WHITE: Color.BLACK;
    ...
    sideToMove() { return this.turn % 2 ? Color.WHITE : Color.BLACK; }
    ...
    move(moveStr) {
        ...
        this.turn++;
        this.stm = this.stm === Color.WHITE ? Color.BLACK : Color.WHITE;
    ...
    push(move) {
        ...
        if (typeof move === 'string') {
            ...
            const built = this.board.buildMoveSan(clean, this.stm);
    ...
    legalMoves(piece) {
        ...
        pieces.forEach((piece) => {
            piece.moveSet.forEach((move) => {
                ...
                // console.log('moveStrs in legalMoves', moveStrs);
    ...
    suggestMove(depth) {
        console.log('eval:', AI.evaluate(this));
